...
// Fetch sender ID (logged-in user)
$sender_id = $user_id; // Assuming $user_id is defined in your user_auth.php or session

// Fetch all active clients that the client has conversations with
$query = "
    SELECT DISTINCT
...
// If no specific client is selected, display the list of clients
      ...
      <div class="col-12 col-md-9 mt-4 mt-md-5">
        ...
        <div class="chat-box border rounded p-3 mb-4" style="height: 700px; overflow-y: scroll;">
            <?php while ($message = mysqli_fetch_assoc($messages_result)): ?>
                <div class="<?php echo $message['sender_id'] == $sender_id ? 'text-end' : 'text-start'; ?> mb-3">
                    <p class="d-inline-block px-3 py-2 rounded bg-<?php echo $message['sender_id'] == $sender_id ? 'primary text-white' : 'secondary text-white'; ?>">
